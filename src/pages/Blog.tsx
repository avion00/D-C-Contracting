...
const Blog = () => {
  ...
  const categories = ["ALL", "RENOVATION", "CONSTRUCTION", "CONTRACTING"];
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl">
                Tips, guides, and perspectives on construction, renovation, remodeling,
                and contracting from the D&amp;C Contracting team.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-12">
              Subscribe for construction tips, project insights, and updates from D&amp;C Contracting
            </p>
